...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite-plugin-vue/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-sfc`;
  ...
  var InvoiceNinjaDashboard_default = {
    ...
    setup(__props, { expose: __expose }) {
      ...
      const __returned__ = { loading, ref, computed: computed2, onMounted };
  ...
  var _withScopeId = (n) => (pushScopeId("data-v-09f26faf"), n = n(), popScopeId(), n);
  var _hoisted_1 = { class: "invoice-ninja-dashboard p-6 max-w-7xl mx-auto" };
  var _hoisted_2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("h2", { class: "text-xl font-semibold" }, "Invoice Ninja Dashboard", -1));
  var _hoisted_3 = {
    key: 0,
    class: "text-center py-4"
  };
  var _hoisted_4 = { key: 1 };
  var _hoisted_5 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("div", { class: "mb-4" }, [
    /* @__PURE__ */ createCommentVNode(" Dashboard content goes here "),
    /* @__PURE__ */ createBaseVNode("p", null, "Welcome to Invoice Ninja Dashboard")
  ], -1));
  var _hoisted_6 = [
    _hoisted_5
  ];
  function render(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_frappe_ui_spinner = resolveComponent("frappe-ui-spinner");
    const _component_Card = resolveComponent("Card");
    return openBlock(), createElementBlock("div", _hoisted_1, [
      createVNode(_component_Card, { class: "mb-6" }, {
        header: withCtx(() => [
          _hoisted_2
        ]),
        default: withCtx(() => [
          $setup.loading ? (openBlock(), createElementBlock("div", _hoisted_3, [
            createVNode(_component_frappe_ui_spinner)
  ...
  function setup_ij_dashboard_vue(wrapper) {
    const app = createApp(InvoiceNinjaDashboard_default2);
...
/*! #__NO_SIDE_EFFECTS__ */
//# sourceMappingURL=invoice_ninja_dashboard.bundle.C6X2CVBG.js.map
